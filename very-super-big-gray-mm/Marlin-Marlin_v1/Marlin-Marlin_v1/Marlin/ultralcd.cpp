...
static void lcd_status_screen()
{
    ...
    {
        lcdDrawUpdate = 2;    //
        lcd_implementation_init();  //ex : 上面 + 這行 = 刷新畫面
...
void lcd_preheat_pla()  //ex : 當按下Preheat PLA選項後執行此段函式
{
...
void lcd_preheat_abs()  //ex : 當按下Preheat ABS選項後執行此段函式
{
...
static void lcd_cooldown()  //ex : 當按下cool down選項後執行此段函式
{
    setTargetHotend0(0);
    setTargetHotend1(0);
    setTargetHotend2(0);
